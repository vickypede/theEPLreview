  ...
  if (!user) {
    return (
      <div className="min-h-screen surface flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-card rounded-3xl shadow-xl p-8 text-center border border-border">
          <div className="mb-8">
            <div className="w-20 h-20 surface-2 rounded-full flex items-center justify-center mx-auto mb-6 border border-border">
          ...
          <button 
            onClick={signIn} 
            className="w-full bg-primary hover:text-foreground text-primary-foreground font-semibold py-4 px-6 rounded-2xl transition-all duration-200 transform hover:scale-105 shadow-lg"
          >
